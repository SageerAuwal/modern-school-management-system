...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* School identity */}
      <div style={{ padding: "22px 20px 18px", borderBottom: "var(--border-width) solid var(--color-border)" }}>
      ...
      {/* Navigation */}
      <div style={{ flex: 1, padding: "10px 10px", display: "flex", flexDirection: "column", gap: 1 }}>
        {NAV.map((item) => {
      ...
      {/* Logout */}
      <div style={{ padding: "10px 10px", borderTop: "var(--border-width) solid var(--color-border)" }}>
        <button
