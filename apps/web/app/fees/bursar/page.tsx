...
export default function BursarConsolePage() {
  ...
  const [activeTab, setActiveTab] = useState<"cashier" | "drawer" | "debtors" | "statement">("cashier");
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
              ...
              <button
                ...
                style={{ fontSize: 12, fontWeight: 700 }}
              >
                {closingDrawer ? "Closing Shift..." : "Confirm & Close Drawer"}
              </button>
            </div>
          </div>
        </div>
